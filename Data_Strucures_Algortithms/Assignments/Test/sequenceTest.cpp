...
{
   CS3358::sequence<double> s1;  // A sequence of double for testing
   CS3358::sequence<char> s2; // A sequence of char for testing
...
Item get_Item()
{
  ...
  cout << "enter a non whitespace char or int " << endl;
  cin >> result;

  while( !cin.good() )
   {
     cerr << "Invalid non-whitespace input " << endl;
     cin.ignore(999,'\n');
     cout << "Re-enter a non whitespace input" << endl;
     cin >> result;
   }
